            ...
            <main className="about-me">
              ...
              <div data-aos="fade-right" className="print-1">
                ...
                <div className="text-about-me">
                  <p> I'm Matheus, and I have many dreams!</p>{" "}
                  <p> The biggest one is becoming a great Devoloper! </p>{" "}
                  <p> And be an inspiration to my family! </p>
                </div>
              </div>
              <div data-aos="fade-left" className="print-2">
                <img
                  src="https://ik.imagekit.io/wwd7wv4ro/projects_images/code1.png?updatedAt=1685991479290"
                  alt="about me image"
                />
                <div className="text-about-me-2">
                  ...
                  <p>
                    My plan is to do my wedding there, "but don't tell my wife"{" "}
                  </p>
                </div>
              </div>
            </main>
            <div className="tech-icons-container">
              ...
              <div className="tech-icons">
                <img
                  ...
                  data-aos-delay="500"
                  src="https://ik.imagekit.io/wwd7wv4ro/programminf_icons/java.png?updatedAt=1685995513996"
                  alt="java icon"
                />
                <img
                  data-aos="flip-left"
                  ...
                  data-aos-delay="600"
                  src="https://ik.imagekit.io/wwd7wv4ro/programminf_icons/python.png?updatedAt=1685995514077"
                  alt="Python icon"
                />
                <img
                  data-aos="flip-left"
                  ...
                  data-aos-delay="700"
                  src="https://ik.imagekit.io/wwd7wv4ro/programminf_icons/javascript.png?updatedAt=1685995513987"
                  alt="Javascript icon"
                />
                <img
                  data-aos="flip-left"
                  ...
                  data-aos-delay="800"
                  src="https://ik.imagekit.io/wwd7wv4ro/programminf_icons/typescript.png?updatedAt=1685995513990"
                  alt="Typescript icon"
                />
                <img
                  data-aos="flip-left"
                  ...
                  data-aos-delay="900"
                  src="https://ik.imagekit.io/wwd7wv4ro/programminf_icons/html-5.png?updatedAt=1685995513970"
                  alt="HTML5 icon"
                />
                <img
                  data-aos="flip-left"
                  ...
                  data-aos-delay="1000"
                  src="https://ik.imagekit.io/wwd7wv4ro/programminf_icons/css.png?updatedAt=1685995513964"
                  alt="CSS3 icon"
                />
                <img
                  data-aos="flip-left"
                  ...
                  data-aos-delay="1100"
                  src="https://ik.imagekit.io/wwd7wv4ro/programminf_icons/mysql__1_.png?updatedAt=1685995513838"
                  alt="MySQL icon"
                />
                <img
                  data-aos="flip-left"
                  ...
                  data-aos-delay="1200"
                  src="https://ik.imagekit.io/wwd7wv4ro/programminf_icons/React-icon.svg.png?updatedAt=1685995514334"
                  alt="React icon"
                />
                <img
                  data-aos="flip-left"
                  ...
                  data-aos-delay="1300"
                  src="https://ik.imagekit.io/wwd7wv4ro/programminf_icons/68747470733a2f2f7061676570726f2e636f2f626c6f672f77702d636f6e74656e742f75706c6f6164732f323032302f30332f72656163742d6e61746976652d6c6f676f2d333234783337352e706e67.webp?updatedAt=1685997367414"
